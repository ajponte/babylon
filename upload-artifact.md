We are building a way to deploy `babylon` as an artifact, which is a Zip module.

## Task
Your task is to design and implement a workflow to build this python project with `tox`, and push the built artifact to Github.
...
## Credentials
This project already connects to Github's artifact server to pull the API spec artifact.
See `https://github.com/ajponte/babylon_api_spec` for how we build that spec and push to Github.
